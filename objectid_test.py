...
class ObjectIdSerializationTest(unittest.TestCase):
    """Test suite for ObjectId serialization fixes"""
    ...
    def test_07_booking_flow_seat_selection(self):
        """Test booking flow with seat selection"""
        if not self.token:
            self.test_01_register_and_login()
...
if __name__ == "__main__":
    print("🚀 Starting ObjectId Serialization Tests...")
    
    # Create test suite
    test_suite = unittest.TestSuite()
    test_suite.addTest(ObjectIdSerializationTest('test_01_register_and_login'))
    test_suite.addTest(ObjectIdSerializationTest('test_02_upcoming_bookings'))
    test_suite.addTest(ObjectIdSerializationTest('test_03_past_bookings'))
    test_suite.addTest(ObjectIdSerializationTest('test_04_admin_users'))
    test_suite.addTest(ObjectIdSerializationTest('test_05_admin_routes'))
    test_suite.addTest(ObjectIdSerializationTest('test_06_admin_buses'))
    test_suite.addTest(ObjectIdSerializationTest('test_07_booking_flow_seat_selection'))
